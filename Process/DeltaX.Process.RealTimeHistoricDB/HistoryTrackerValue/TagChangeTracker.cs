namespace DeltaX.Process.RealTimeHistoricDB.HistoryTrackerValue
{
    ...
    class TagChangeTracker
    {
        ...
        public HistoricTagValueRecord GetLastHistoricTagValue(DateTime? forceDateTime = null)
        {
            double updated = forceDateTime.HasValue && this.Updated < forceDateTime
                ? forceDateTime.Value.ToUnixTimestamp()
